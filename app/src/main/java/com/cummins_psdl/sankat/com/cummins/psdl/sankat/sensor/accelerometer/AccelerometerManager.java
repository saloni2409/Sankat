...
public class AccelerometerManager {
    ...
    public static void startListening( AccelerometerListener accelerometerListener )
    {
        ...
        if (sensors.size() > 0) {
            ...
            // com.cummins_psdl.sankat.Register Accelerometer Listener
    ...
    private static SensorEventListener sensorEventListener =
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            // on the com.cummins_psdl.sankat.com.cummins.psdl.sankat.sensor.utility.AccelerometerListener implementation
            // processing time
            now = event.timestamp;
